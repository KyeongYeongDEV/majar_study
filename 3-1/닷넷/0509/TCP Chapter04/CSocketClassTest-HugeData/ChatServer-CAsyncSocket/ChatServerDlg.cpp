...
void CChatServerDlg::OnSendButton() 
{
	// TODO: Add your control notification handler code here
//	UpdateData(TRUE);
//	m_ServerSocket.m_Agent.Send(m_szMessage, 200);

//	m_szMessage.Empty();
	m_szMessage="Only test for huge data communication"; 
	UpdateData(FALSE);
