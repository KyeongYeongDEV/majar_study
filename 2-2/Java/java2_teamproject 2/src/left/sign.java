...
public class sign {
    ...
    public static void setSign(){
        ...
        CalendarSwing.sign_pw.setFont(new Font("Dialog",Font.BOLD,15));
        l2.setFont(new Font("Dialog",Font.BOLD,15));
        sign_f2.add(l2);
        sign_f2.add(CalendarSwing.sign_pw); //회원가입 비밀번호 텍스트필드
        ...
        CalendarSwing.sign_pwcheck.setFont(new Font("Dialog",Font.BOLD,15));
        l3.setFont(new Font("Dialog",Font.BOLD,15));
        sign_f3.add(l3);
        sign_f3.add(CalendarSwing.sign_pwcheck);//회원가입 비밀번호 체크
        ...
        CalendarSwing.sign_ok.setFont(new Font("Dialog",Font.BOLD,15));
        CalendarSwing.sign_cancel.setFont(new Font("Dialog",Font.BOLD,15));
        sign_f5.add(CalendarSwing.sign_ok); //회원가입 성공하면 빈칸으로
