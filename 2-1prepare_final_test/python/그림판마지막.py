...
Button(window,text="blue",command= blue).grid(row=2, column=1)
Button(window,text="yellow",command=yellow ).grid(row=2, column=2)
Button(window,text="black",command= black).grid(row=2, column=3)
Button(window,text="clear",command= delete).grid(row=2, column=4)
